...
const Premier = () => {
  ...
  const getColorClass = (index) => {
    ...
    if (selectedYear === '2023-2024') {
      ...
      if (index === 4 || index === 7) return style.yellowCircle;
      if (index === 5) return style.blueCircle;
      if (index >= totalTeams - 3) return style.redCircle;
    } else if (selectedYear === '2022-2023') {
      if (index < 4) return style.greenCircle;
      if (index === 4 ||index===5 || index === 13) return style.yellowCircle;
  ...
  return (
    <div className={style.premierContainer}>
